...
vi.mock("../../data/2021-22-goals.json", () => ({
  default: [
    {
...
vi.mock("../../data/2021-22-matches.json", () => ({
  default: [
    {
      details: [
        {
...
describe("FootballSeason202122", () => {
  it("renders the page with correct title", () => {
    render(
      <TestWrapper>
        <FootballSeason202122 />
      </TestWrapper>
    );
  ...
  it("renders season results with correct data", () => {
    ...
    expect(screen.getByText("Season: 2021-2022")).toBeInTheDocument();
