...
vi.mock("../../data/2020-21-goals.json", () => ({
  default: [{ some: "goals data" }],
}));

vi.mock("../../data/2020-21-matches.json", () => ({
  default: [{ some: "matches data" }],
}));

describe("FootballSeason202021", () => {
  it("renders the page with correct title", () => {
    render(
      <TestWrapper>
        <FootballSeason202021 />
      </TestWrapper>
    );
  ...
  it("renders season results with correct data", () => {
    ...
    expect(screen.getByText("Season: 2020-2021")).toBeInTheDocument();
